...
项目包含 Solidity 合约和中英双语签到页面，使用 TypeScript、Vite 与 ethers v6，无需后端。页面提供哥特风视觉与中文/英文切换，语言选择保存在浏览器中；中文标题为“签到签到，共同奔向A8！”。支持累计签到、当前连续签到、最长连续签到、最近 7 天记录及链上签到排行榜。公开网站只有签到功能，没有合约部署或切换合约入口。
